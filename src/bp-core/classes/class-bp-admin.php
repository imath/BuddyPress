		...
		<div id="bp-hello-container">
			<div id="plugin-information-scrollable">
				...
				<div class="bp-hello-content">
					...
					<div id="top-features">
						<h2><?php esc_html_e( 'Say hello to the two first BuddyPress blocks!', 'buddypress' ); ?></h2>
						<figure class="bp-hello-aligncenter">
							<img src="https://cldup.com/__oRAUhyfw.gif" alt="<?php esc_attr_e( 'Gif Animation showing how to insert the BuddyPress Group Block.', 'buddypress' ); ?>" />
						</figure>
						<p>
							<?php esc_html_e( 'BuddyPress 6.0.0 comes with two awesome blocks for your WordPress Editor: the BP Member and the BP Group Blocks.', 'buddypress' ); ?>
							<?php esc_html_e( 'Available from the BuddyPress blocks category of your WordPress Block inserter, these lovely blocks let you feature a specific member or group of your wonderful community site into your WordPress posts or pages.', 'buddypress' ); ?>
							<br/>
							<?php printf(
								/* translators: %s is the placeholder for the link to the Advanced section of the BP Blocks development note. */
								esc_html__( 'You\'re an Advanced BuddyPresser and wish to fine tune the BuddyPress blocks for your community site? Have a look to %s about the BP Blocks.', 'buddypress' ),
								sprintf(
									'<a href="%1$s">%2$s</a>',
						...
						<p>
							<?php printf(
								...
								esc_html__( 'In 5.0.0, we’ve introduced the first endpoints and a %s about them.', 'buddypress' ),
								sprintf(
									'<a href="%1$s">%2$s</a>',
							...
							<?php esc_html_e( 'In 6.0.0, we are adding the 6 remaining endpoints you were waiting for: Blogs, Blog avatar, Friends, Group Cover image, Member Cover Image and User Signups. You can now build great BuddyPress full featured Apps!', 'buddypress' ); ?>
						</p>
						...
						<p>
							<?php esc_html_e( 'Your active theme is supporting wide alignments? Awesome! BP Nouveau is now supporting them too: let\'s have wider community areas for your site.', 'buddypress' ); ?>
						</p>
						<figure class="bp-hello-aligncenter">
							<img src="https://cldup.com/88Rls8sPkG.png" alt="<?php esc_attr_e( 'Screenshot of the BP Nouveau customizer setting to enjoy wide alignments', 'buddypress' ); ?>" />
						</figure>
						<p>
							<?php esc_html_e( 'This is the first of the many improvements we brought to our default Template Pack. It never looked so beautiful into your theme.', 'buddypress' ); ?>
						</p>
						...
						<p>
							<?php esc_html_e( '6.0.0 made more than 80 changes to improve your BuddyPress experience as users, as contributors to our code and as contributors to our translations.', 'buddypress' ); ?>
						</p>
						<p>
							<?php printf(
								/* translators: %s is the placeholder for the link to the Avatar changes development note. */
								esc_html__( 'The biggest one is about local avatar management, this feature now belongs to the Members component. Read more about it thanks to %s.', 'buddypress' ),
								sprintf(
									'<a href="%1$s">%2$s</a>',
						...
						<p>
							<?php esc_html_e( 'Knowing how you use BuddyPress and getting your point of view about possible futures for BuddyPress is very important to us.', 'buddypress' ); ?>
							<?php esc_html_e( 'Please, take some minutes to help us decide what\'s best for the BuddyPress project.', 'buddypress' ); ?>
						</p>
